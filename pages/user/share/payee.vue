<template>
	<CustomPage>
		<view class="page_container share-payee">
			<view class="page_content">
				...
				<view class="footer_content">
					<view class="button_box">
						<u-button text="保存信息" :loading="buttonLoading" :customStyle="{ ...buttonStyle, ...themeButton.general[theme] }" @click="submitHandle" />
					</view>
				</view>
			</view>
		</view>
	...
	export default {
		data() {
			return {
				...
				wxParams: {
					name: '',
					// fullurl: "https://www.osaigc.com/uploads/20230526/b69d7d1cbbff0f828ff3dff354ecca3c.png",
				...
				uni.chooseImage({
					...
					success: chooseImageRes => {
						...
						const uploadTask = uni.uploadFile({
							url: this.$BASE_URL + '/addons/chatgpt/index/upload', //仅为示例，非真实的接口地址
